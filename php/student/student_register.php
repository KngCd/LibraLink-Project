                ...
                <section class="bg-success">
                    <div class="row">
                        ...
                        mt-lg-5 mt-md-5 mt-sm-5 mt-5 mb-5">
                            <a href="student-login.php" class="text-dark"><h1 style="font-size: 4rem;">Elevate your Library Experience</h1></a>
                        </div>
                        ...
                        ?>
                        <form action="student_register.php" method="post" enctype="multipart/form-data" class="bg-warning">
